...
const { loadConfig, resolveModelInternal, findPhaseInternal, getRoadmapPhaseInternal, pathExistsInternal, generateSlugInternal, getMilestoneInfo, getMilestonePhaseFilter, stripShippedMilestones, extractCurrentMilestone, normalizePhaseName, toPosixPath, output, error , buildPhaseBase, applyIncludes } = require('./core.cjs');
 ...
 * Workflows use this to prefix `.planning/` paths correctly when Antigravity's CWD
