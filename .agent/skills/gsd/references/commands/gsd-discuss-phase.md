...
@references/workflows/discuss-phase-assumptions.md
@references/workflows/discuss-phase-power.md
...
**Mode routing:**
```bash
DISCUSS_MODE=$(node ".agent/skills/gsd/bin/gsd-tools.cjs" config-get workflow.discuss_mode 2>/dev/null || echo "discuss")
```

If `DISCUSS_MODE` is `"assumptions"`: Read and execute @references/workflows/discuss-phase-assumptions.md end-to-end.

If `DISCUSS_MODE` is `"discuss"` (or unset, or any other value): Read and execute @references/workflows/discuss-phase.md end-to-end.
