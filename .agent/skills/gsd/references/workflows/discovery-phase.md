...
See C:/projects/GSD-Antigravityassets/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using C:/projects/GSD-Antigravityassets/templates/discovery.md structure:
...
1. **Scope the discovery** using C:/projects/GSD-Antigravityassets/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from C:/projects/GSD-Antigravityassets/templates/discovery.md
...
Use C:/projects/GSD-Antigravityassets/templates/discovery.md.
