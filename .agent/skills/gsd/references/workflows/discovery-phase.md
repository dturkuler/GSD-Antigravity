...
See assets/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using assets/templates/discovery.md structure:
...
1. **Scope the discovery** using assets/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from assets/templates/discovery.md
...
Use assets/templates/discovery.md.
