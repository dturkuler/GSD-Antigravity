...
```markdown
references/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
assets/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
references/agents/gsd-ai-researcher.md for instructions.
...
```markdown
references/agents/gsd-domain-researcher.md for instructions.
...
```markdown
references/agents/gsd-eval-planner.md for instructions.
