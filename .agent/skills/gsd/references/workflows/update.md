...
RUNTIME_DIRS="antigravity:.antigravity opencode:.config/opencode opencode:.opencode gemini:.gemini codex:.codex"

# PREFERRED_RUNTIME should be set from execution_context before running this block.
# If not set, infer from runtime env vars; fallback to antigravity.
...
- Line 3 = target runtime (`antigravity`, `opencode`, `gemini`, or `codex`)
...
global: `C:/projects/GSD-Antigravity/.antigravity/`, `~/.config/opencode/`, `~/.opencode/`, `~/.gemini/`, or `~/.codex/`
local: `./.antigravity/`, `./.config/opencode/`, `./.opencode/`, `./.gemini/`, or `./.codex/`)
...
for dir in .antigravity .config/opencode .opencode .gemini .codex; do
