...
```bash
.agent/skills/gsd/bin/gsd-tools.cjs" init manager)
...
.agent/skills/gsd/bin/gsd-tools.cjs\" init plan-phase {N}
...
.agent/skills/gsd/bin/gsd-tools.cjs\" init execute-phase {N}
