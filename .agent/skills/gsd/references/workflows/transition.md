...
```bash
TRANSITION=$(node ./.antigravity/get-shit-done/bin/gsd-tools.js phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node ./.antigravity/get-shit-done/bin/gsd-tools.js progress bar --raw)
```
