...
```bash
TRANSITION=$(node "C:/projects/GSD-Antigravity.agent/skills/gsd/bin/gsd-tools.cjs" phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node "C:/projects/GSD-Antigravity.agent/skills/gsd/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
node "C:/projects/GSD-Antigravity.agent/skills/gsd/bin/gsd-tools.cjs" config-set workflow._auto_chain_active false
```
