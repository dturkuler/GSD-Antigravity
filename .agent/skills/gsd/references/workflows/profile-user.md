...
Key references:
- @references/docs/ui-brand.md (display patterns)
- @C:/projects/GSD-Antigravity/.antigravity/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @references/docs/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/projects/GSD-Antigravity/.antigravity/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/projects/GSD-Antigravity/.antigravity/get-shit-done/USER-PROFILE.md" "C:/projects/GSD-Antigravity/.antigravity/get-shit-done/USER-PROFILE.backup.md"
```
...
Antigravity starts every conversation generic. A profile teaches Antigravity
how YOU actually work -- not how you think you work.

## What We'll Analyze

Your recent Antigravity sessions, looking for patterns in these
...
| Frustration Triggers | What makes you correct Antigravity                |
...
✓ Stores profile at C:/projects/GSD-Antigravity/.antigravity/get-shit-done/USER-PROFILE.md
...
Run session scan:
```bash
.agent/skills/gsd/bin/gsd-tools.cjs scan-sessions --json 2>/dev/null)
```
...
```bash
.agent/skills/gsd/bin/gsd-tools.cjs profile-sample --json 2>/dev/null)
```
...
- The user-profiling reference doc at `C:/projects/GSD-Antigravity/.antigravity/get-shit-done/references/user-profiling.md`
...
Reference: @references/docs/user-profiling.md
...
**Get questions:**
```bash
.agent/skills/gsd/bin/gsd-tools.cjs profile-questionnaire --json 2>/dev/null)
```
...
```bash
.agent/skills/gsd/bin/gsd-tools.cjs profile-questionnaire --answers "$ANSWERS_PATH" --json 2>/dev/null)
```
...
```bash
.agent/skills/gsd/bin/gsd-tools.cjs write-profile --input "$ANALYSIS_PATH" --json 2>/dev/null
```
...
- **Frustrations (MEDIUM):** You correct Antigravity most often for doing things
...
**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/projects/GSD-Antigravity/.antigravity/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
```bash
.agent/skills/gsd/bin/gsd-tools.cjs generate-antigravity-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
.agent/skills/gsd/bin/gsd-tools.cjs generate-antigravity-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```
...
```bash
BACKUP_PATH="C:/projects/GSD-Antigravity/.antigravity/get-shit-done/USER-PROFILE.backup.md"
```
...
Your profile:    C:/projects/GSD-Antigravity/.antigravity/get-shit-done/USER-PROFILE.md
```
