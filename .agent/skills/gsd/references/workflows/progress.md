...
```bash
INIT=$(node .agent/skills/gsd/bin/gsd-tools.js init progress --include state,roadmap,project,config)
```
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node .agent/skills/gsd/bin/gsd-tools.js summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node .agent/skills/gsd/bin/gsd-tools.js progress bar --raw)
```
