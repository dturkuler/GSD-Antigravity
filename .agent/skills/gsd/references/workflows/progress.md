...
```bash
INIT=$(node .agent/skills/gsd/bin/gsd-tools.cjs init progress)
```
...
- `STATE=$(node .agent/skills/gsd/bin/gsd-tools.cjs state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node .agent/skills/gsd/bin/gsd-tools.cjs summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node .agent/skills/gsd/bin/gsd-tools.cjs progress bar --raw)
```
