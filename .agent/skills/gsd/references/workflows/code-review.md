...
.agent/skills/gsd/bin/gsd-tools.cjs" config-get workflow.code_review_depth 2>/dev/null`
3. Default: "standard"
...
.agent/skills/gsd/bin/gsd-tools.cjs" config-get workflow.code_review_depth 2>/dev/null || echo "")
