...
PHASES=$(node .agent/skills/gsd/bin/gsd-tools.js phases list)
...
```bash
node .agent/skills/gsd/bin/gsd-tools.js commit "docs(roadmap): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md
```
