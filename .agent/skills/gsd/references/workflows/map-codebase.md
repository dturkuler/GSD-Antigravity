...
```bash
INIT=$(node .agent/skills/gsd/bin/gsd-tools.js init map-codebase)
```
...
```bash
node .agent/skills/gsd/bin/gsd-tools.js commit "docs: map existing codebase" --files .planning/codebase/*.md
```
