...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.antigravity/skills/sketch-findings-[project]/`
...
3. Check if `./.antigravity/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.antigravity/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.antigravity/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.antigravity/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.antigravity/skills/` with SKILL.md, references/, sources/
