...
parallel milestone work by multiple Antigravity instances on the same codebase.
...
Antigravity/Codex instances are active on the same repo at the same time. One session can
