...
- Messages are already filtered to genuine user messages only (system messages, tool results, and Antigravity responses are excluded)
...
<reference>
@references/docs/user-profiling.md
...
Read the user-profiling reference document at `C:/projects/GSD-Antigravity/.antigravity/get-shit-done/references/user-profiling.md` to load:
