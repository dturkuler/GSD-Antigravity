...
- Research the single assigned gray area using Antigravity's knowledge, Context7, and web search
...
4. Use Antigravity's knowledge + Context7 + web search to verify current best practices.
