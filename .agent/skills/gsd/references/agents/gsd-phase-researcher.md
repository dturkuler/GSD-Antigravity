...
**The trap:** Antigravity "knows" things confidently, but knowledge may be outdated, incomplete, or wrong.
...
```bash
node "C:/projects/GSD-Antigravity.agent/skills/gsd/bin/gsd-tools.cjs" websearch "your query" --limit 10
```
...
| **Antigravity's Discretion** | Research options, make recommendations |
| **Deferred Ideas** | Out of scope — ignore completely |
...
[Copy verbatim from CONTEXT.md ## Antigravity's Discretion]
...
```bash
node "C:/projects/GSD-Antigravity.agent/skills/gsd/bin/gsd-tools.cjs" commit "docs($PHASE): research phase domain" --files "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```
