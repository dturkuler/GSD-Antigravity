...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/projects/GSD-Antigravity/.antigravity
.agent/skills/gsd/bin/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/projects/GSD-Antigravity/.antigravity/get-shit-done
                  → writes to C:/projects/GSD-Antigravity/.antigravity/get-shit-done/hooks/
