...
- **[`gsd:plan-phase`](references/commands/plan-phase.md)**: Create detailed execution plan for a phase (PLAN.md) with verification loop
...
---
*Generated by gsd-converter on 2026-02-08*
