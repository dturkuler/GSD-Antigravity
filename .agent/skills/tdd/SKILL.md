...
2. Append a one-line summary of what is now pinned to `.planning/KNOWLEDGE.md` if the behavior is non-obvious or the test surfaced a trap future agents should know about.
